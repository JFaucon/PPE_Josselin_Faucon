...
class Forfait
{
    ...
    #[ORM\Column]
    private ?int $nbSlot = null;

    #[ORM\Column]
    private ?int $discount = null;

    #[ORM\Column]
    private ?int $nbMonth = null;
    ...
    public function setNbSlot(int $nbSlot): static
    {
        $this->nbSlot = $nbSlot;
    ...
    public function getNbMonth(): ?int
    {
        return $this->nbMonth;
    }

    public function setNbMonth(int $nbMonth): static
    {
